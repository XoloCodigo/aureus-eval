        ...
        'tabs' => [
            'sales-purchase' => [
                ...
                'fields' => [
                    ...
                    'company-id-hint-text'  => 'El número de registro de la empresa, usado si es diferente del RFC. Debe ser único entre todos los contactos dentro del mismo país.',
        ...
        'tabs' => [
            'sales-purchase' => [
                ...
                'fields' => [
                    ...
                    'responsible-hint-text' => 'Este es el comercial interno responsable de este cliente',
                    'company-id'            => 'ID de empresa',
                    'company-id-hint-text'  => 'El número de registro de la empresa. Úselo si es diferente del RFC. Debe ser único entre todos los contactos de un mismo país',
                    'reference'             => 'Referencia',
                    'industry'              => 'Sector',
                ],
            ],
